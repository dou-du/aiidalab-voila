...
<div id="rendered_cells" style="display: none">
  ...
  <main style="background-color:#e6e6e6">
    <div class="fb-share-button" style="position: absolute; margin-left: 10px; margin-top: 2px;" data-href=window.location.href data-layout="button_count" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
    <div class="container">
      <div class="row">
