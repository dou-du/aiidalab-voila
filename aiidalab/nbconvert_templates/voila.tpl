...
{%- endblock body_header -%}
  ...
  <div class="fb-share-button" style="height: 0px; margin-left: 10px; margin-top: 2px;" data-href=window.location.href data-layout="button_count" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
    <div class="container">
      <div class="row">
